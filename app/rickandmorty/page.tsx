// SSG: cache forzado con force-cache. Los datos se generan en build time.
// ISR: revalidate cada 10 días para actualizar sin reconstruir.
...
async function getCharacters(): Promise<SimpleCharacter[]> {
  // force-cache: fuerza el caché en la petición → comportamiento SSG
    ...
    <div className="p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <p className="text-gray-500 text-center mt-10 text-sm">
          Usa{" "}
          <Link href="/rickandmorty/search" className="text-green-400 underline">
            Buscar personajes
          </Link>{" "}
